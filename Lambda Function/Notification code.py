...
def lambda_handler(event, context):
    sns_topic_arn = 'arn:aws:sns:us-east-1:718777626589:notificationsystemtopic'

    # Define the SQS queue URL
    sqs_queue_url = 'https://sqs.us-east-1.amazonaws.com/718777626589/notificationqueue'
